...
class User(BaseModel):
    ...
    registered_at: Optional[datetime] = Field(default=None, alias="created_at", description="首次使用时间")
    last_active_at: Optional[datetime] = Field(default=None, alias="updated_at", description="最后活跃时间")
